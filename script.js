...
function renderCurrentCard() {
  ...
  container.innerHTML = `
    ...
    ">
      <div style="color: #d97706; font-weight: bold; margin-bottom: 12px; font-size: 0.95em;">
        ${family.title}
      </div>
      <div style="color: #222222; line-height: 1.7; font-size: 0.95em;">
        ${family.content}
      </div>
    </div>
  `;
